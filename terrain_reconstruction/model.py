...
def _require_minkowski_engine() -> None:
    if ME is None:
        raise ImportError(
            "MinkowskiEngine is required for the terrain reconstruction model. "
            "Install it first, then rerun train.py."
        )
